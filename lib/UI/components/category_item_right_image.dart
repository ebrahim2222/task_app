...
class ItemRightImage extends StatelessWidget {
  final int index;
  final CategoriesController controller;
  const ItemRightImage(
    ...
    return ScreenUtilInit(builder: (context, child) {
      return Container(
        ...
        child: Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
            ...
            children: [
              ...
              Container(
                margin: EdgeInsets.only(
                    left: AppMargin.m18.w, top: AppMargin.m12.h),
                width: Get.width * 0.4,
                child: Text(
                  controller
          ...
          Container(
            margin:
                EdgeInsets.only(right: AppMargin.m20.w, top: AppMargin.m12.h),
            width: Get.width * 0.2,
            child: Image.network(
